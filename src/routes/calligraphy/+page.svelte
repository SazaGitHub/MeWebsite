...
<div>
	<Card id="calligraphy info">
		I started calligraphy while in Japan for the first time, and ever since
		then it has become an important part of my life. I primarily write in what
		is called 草書 (Sousho), meaning "grass write" which is a highly cursive
		style.
	</Card>
</div>
